...
/*!****************************!*\
  !*** ./source/js/const.js ***!
  \****************************/
/*! exports provided: DEFAULT_TIMER_SEC */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "DEFAULT_TIMER_SEC", function() { return DEFAULT_TIMER_SEC; });
...
/* harmony import */ var _vars__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../vars */ "./source/js/vars.js");
/* harmony import */ var _page_overlay__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./page-overlay */ "./source/js/modules/page-overlay.js");
...
class FullPageScroll {
  constructor() {
    ...
    this.scrollHandler = lodash_throttle__WEBPACK_IMPORTED_MODULE_0___default()(
    ...
    this.pageOverlay = new _page_overlay__WEBPACK_IMPORTED_MODULE_2__["default"](
        _vars__WEBPACK_IMPORTED_MODULE_1__["default"].pageOverlay,
  ...
  checkTransitionFromStoryToPrizes() {
    ...
    return (
      currentScreen && currentScreen.id === _vars__WEBPACK_IMPORTED_MODULE_1__["Screens"].STORY &&
      nextScreen === _vars__WEBPACK_IMPORTED_MODULE_1__["Screens"].PRIZES
    );
  }

  checkAnimationScreenInMain() {
    if (this.screenElements[this.activeScreen].id === _vars__WEBPACK_IMPORTED_MODULE_1__["Screens"].TOP) {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _vars__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../vars */ "./source/js/vars.js");


/* harmony default export */ __webpack_exports__["default"] = (() => {
  window.addEventListener(`load`, () => {
    _vars__WEBPACK_IMPORTED_MODULE_0__["default"].body.classList.add(`is-load`);
  });
});
...
/***/ "./source/js/modules/page-overlay.js":
/*!*******************************************!*\
  !*** ./source/js/modules/page-overlay.js ***!
  \*******************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return PageOverlay; });
class PageOverlay {
...
class PrizesAnimation {
  ...
  startAnimation() {
    if (!this.prizesList.classList.contains(`prizes__list--active`)) {
      ...
      this.svgIcons.forEach((svgIcon) => {
        if (_utils__WEBPACK_IMPORTED_MODULE_1__["default"].isDesktop()) {
          _utils__WEBPACK_IMPORTED_MODULE_1__["default"].updateImageVersion(svgIcon);
        }
      });
    }
  }
  ...
  _checkPage(params) {
    if (params.screenName === _vars__WEBPACK_IMPORTED_MODULE_0__["Screens"].PRIZES) {
      this.startAnimation();
    }
  }
...
/* harmony default export */ __webpack_exports__["default"] = (animateResultSvg);
...
const onShowResultElClick = (showResultEl, results) => {
  ...
  Object(_result_animation__WEBPACK_IMPORTED_MODULE_0__["default"])();
};
...
/***/ "./source/js/modules/screen-titles.js":
/*!********************************************!*\
  !*** ./source/js/modules/screen-titles.js ***!
  \********************************************/
/*! no exports provided */
...
/* harmony import */ var _vars__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../vars */ "./source/js/vars.js");
/* harmony import */ var _utils__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../utils */ "./source/js/utils.js");
/* harmony import */ var _titles_data__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./titles-data */ "./source/js/modules/titles-data.js");
...
class ScreenTitles {
  constructor() {
    this._mainTitleAnim = new _letter_animation__WEBPACK_IMPORTED_MODULE_0__["default"](_titles_data__WEBPACK_IMPORTED_MODULE_3__["mainTitleData"]);
    this._introDateAnim = new _letter_animation__WEBPACK_IMPORTED_MODULE_0__["default"](_titles_data__WEBPACK_IMPORTED_MODULE_3__["introDateData"]);
    this._storyTitleAnim = new _letter_animation__WEBPACK_IMPORTED_MODULE_0__["default"](_titles_data__WEBPACK_IMPORTED_MODULE_3__["storyTitleData"]);
    this._prizesTitleAnim = new _letter_animation__WEBPACK_IMPORTED_MODULE_0__["default"](_titles_data__WEBPACK_IMPORTED_MODULE_3__["prizesTitleData"]);
    this._rulesTitleAnim = new _letter_animation__WEBPACK_IMPORTED_MODULE_0__["default"](_titles_data__WEBPACK_IMPORTED_MODULE_3__["rulesTitleData"]);
    this._gameTitleAnim = new _letter_animation__WEBPACK_IMPORTED_MODULE_0__["default"](_titles_data__WEBPACK_IMPORTED_MODULE_3__["gameTitleData"]);
  ...
  _checkPage(params) {
    switch (params.screenName) {
      case _vars__WEBPACK_IMPORTED_MODULE_1__["Screens"].TOP:
        this.animateMainScreenTitles();
        break;
      case _vars__WEBPACK_IMPORTED_MODULE_1__["Screens"].STORY:
        this.animateStoryScreenTitle();
        break;
      case _vars__WEBPACK_IMPORTED_MODULE_1__["Screens"].PRIZES:
        this.animatePrizesScreenTitle();
        break;
      case _vars__WEBPACK_IMPORTED_MODULE_1__["Screens"].RULES:
        this.animateRulesScreenTitle();
        break;
      case _vars__WEBPACK_IMPORTED_MODULE_1__["Screens"].GAME:
  ...
  animateMainScreenTitles() {
    _utils__WEBPACK_IMPORTED_MODULE_2__["default"].delay(100).then(() => this._mainTitleAnim.runAnimation());

    _utils__WEBPACK_IMPORTED_MODULE_2__["default"].delay(500).then(() => this._introDateAnim.runAnimation());
  }
  ...
  animateStoryScreenTitle() {
    _utils__WEBPACK_IMPORTED_MODULE_2__["default"].delay(100).then(() => this._storyTitleAnim.runAnimation());
  }
  ...
  animatePrizesScreenTitle() {
    _utils__WEBPACK_IMPORTED_MODULE_2__["default"].delay(100).then(() => this._prizesTitleAnim.runAnimation());
  }
  ...
  animateRulesScreenTitle() {
    _utils__WEBPACK_IMPORTED_MODULE_2__["default"].delay(100).then(() => this._rulesTitleAnim.runAnimation());
  }
  ...
  animateGameScreenTitle() {
    _utils__WEBPACK_IMPORTED_MODULE_2__["default"].delay(100).then(() => this._gameTitleAnim.runAnimation());
  }
...
class Timer {
  constructor(time = _const__WEBPACK_IMPORTED_MODULE_0__["DEFAULT_TIMER_SEC"]) {
    this.localTime = time;
  ...
  _checkPage(params) {
    if (params.screenName === _vars__WEBPACK_IMPORTED_MODULE_1__["Screens"].GAME) {
...
/***/ "./source/js/modules/titles-data.js":
/*!******************************************!*\
  !*** ./source/js/modules/titles-data.js ***!
  \******************************************/
/*! exports provided: mainTitleData, introDateData, storyTitleData, prizesTitleData, rulesTitleData, gameTitleData */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "mainTitleData", function() { return mainTitleData; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "introDateData", function() { return introDateData; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "storyTitleData", function() { return storyTitleData; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "prizesTitleData", function() { return prizesTitleData; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "rulesTitleData", function() { return rulesTitleData; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "gameTitleData", function() { return gameTitleData; });
const mainTitleData = {
...
/* harmony import */ var _modules_loader__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./modules/loader */ "./source/js/modules/loader.js");
/* harmony import */ var _modules_screen_titles__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./modules/screen-titles */ "./source/js/modules/screen-titles.js");
/* harmony import */ var _modules_prizes_animation__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./modules/prizes-animation */ "./source/js/modules/prizes-animation.js");
/* harmony import */ var _modules_timer__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./modules/timer */ "./source/js/modules/timer.js");
// modules
...
// init modules
Object(_modules_loader__WEBPACK_IMPORTED_MODULE_10__["default"])();
...
const rules = new _modules_rules__WEBPACK_IMPORTED_MODULE_9__["default"]();
rules.init();
...
/*!***************************!*\
  !*** ./source/js/vars.js ***!
  \***************************/
/*! exports provided: Screens, default */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
